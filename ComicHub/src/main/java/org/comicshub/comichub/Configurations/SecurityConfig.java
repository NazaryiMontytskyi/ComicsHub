                ...
                .authorizeHttpRequests(
                        authorize ->
                                authorize
                                        ...
                                        .requestMatchers("/comics/new", "/comics/edit/", "/comics/delete/").hasAnyRole("USER", "ADMIN")
                                        .requestMatchers("/favourites").hasAnyRole("USER", "ADMIN")
                                        .requestMatchers("/userread/**").hasAnyRole("USER", "ADMIN")
                                        .requestMatchers("/viewPdf/**").permitAll()
                                        .requestMatchers("/my_account").hasAnyRole("USER", "ADMIN")
                                        .requestMatchers("/admin/**").hasRole("ADMIN")
                                        .requestMatchers("/username", "/password", "/avatar", "/users/delete").hasAnyRole("USER", "ADMIN")
